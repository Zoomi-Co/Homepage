...
var Styles = /*#__PURE__*/function (_$e$modules$editor$do) {
  ...
  (0, _createClass2.default)(Styles, [{
    ...
    value: function apply(args) {
      ...
      var oldStyles = (_container$model$get = container.model.get('styles')) !== null && _container$model$get !== void 0 ? _container$model$get : {};
      var oldBindSetting = container.settings.get(bind);
      var style = {};
      if (!styleDefId) {
    ...
    value: function restore(historyItem, isRedo) {
      ...
      var changes = historyItem.get('data').changes;
      $e.internal('document/elements/set-settings', {
        container: container,
        options: {
          render: false
